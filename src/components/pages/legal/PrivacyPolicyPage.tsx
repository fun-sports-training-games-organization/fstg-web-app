    ...
    return (
        ...
        >
            <Grid pt={'50px'} pb={'50px'} pl={'100px'} pr={'100px'} item xs={3}>
                ...
                <Typography mb={1} textAlign={'left'} variant={'h5'}>
                ...
                <Typography mb={1} textAlign={'left'} variant={'h6'}>
                    Log Data
                </Typography>
                <Typography mb={1} textAlign={'left'} variant={'body1'}>
                ...
                <List sx={{ textAlign: 'left' }}>
                    <ListItem>
                        ...
                        <ListItemText>Use a mobile device or web browser to access our content</ListItemText>
                    </ListItem>
                    <ListItem>
                        <ListItemIcon>
                            <FiberManualRecord />
                        </ListItemIcon>
                        <ListItemText>Contact us via email, social media, or on any similar technologies</ListItemText>
                    </ListItem>
                    <ListItem>
                        <ListItemIcon>
                            <FiberManualRecord />
                        </ListItemIcon>
                        <ListItemText>When you mention us on social media</ListItemText>
                    </ListItem>
                </List>
                <Typography mb={1} textAlign={'left'} variant={'body1'}>
                ...
                <List>
                    <ListItem>
                        ...
                        <ListItemText>a parent, subsidiary, or affiliate of our company</ListItemText>
                    </ListItem>
                    <ListItem>
                        <ListItemIcon>
                            <FiberManualRecord />
                    ...
                    <ListItem>
                        ...
                        <ListItemText>our employees, contractors, and/or related entities</ListItemText>
                    </ListItem>
                    <ListItem>
                        <ListItemIcon>
                            <FiberManualRecord />
                        </ListItemIcon>
                        <ListItemText>our existing or potential agents or business partners</ListItemText>
                    </ListItem>
                    <ListItem>
                        <ListItemIcon>
                            <FiberManualRecord />
                ...
                <Typography mb={1} textAlign={'left'} variant={'body1'}>
                    The personal information we collect is stored and/or processed where we or our partners, affiliates,
                ...
                <Typography mb={1} textAlign={'left'} variant={'body1'}>
                    ...
                    policy. You retain the right to request details of any personal information we hold about you.
                </Typography>
                <Typography mb={1} textAlign={'left'} variant={'body1'}>
                ...
                <Typography mb={1} textAlign={'left'} variant={'body1'}>
                    ...
                    <br />
                    fun.sports.training.games@gmail.com
                </Typography>
            </Grid>
        </Grid>
    );
